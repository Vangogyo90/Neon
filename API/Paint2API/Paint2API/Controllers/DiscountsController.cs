...
namespace Paint2API.Controllers
{
    ...
    public class DiscountsController : ControllerBase
    {
        ...
        [Authorize(Roles = "3")]
        [HttpDelete("DeleteDiscountByColorId/{id}")]
        public async Task<IActionResult> DeleteDiscountByColorId(int? id)
        {
            if (id == null)
            {
            ...
            var discounts = await _context.Discounts.Where(a => a.ColorId == id).ToListAsync();
