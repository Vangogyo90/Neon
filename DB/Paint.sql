...
[Patromymic] [varchar] (50) not null,
...
[Number_Or_E_mail] [varchar] (50) not null,
...
[Heading_News] [varchar] (150) not null,
...
[Name_Status_Order] [varchar] (50) unique,
...
[Name_Ral] [varchar] (100) not null unique,
[Color_Ral] [varchar] (5) not null unique,
[Color_HTML] [varchar] (8) not null unique,

constraint [PK_Ral_Catalog] primary key clustered ([ID_Ral_Catalog]),
constraint [Color_Ral_Mask] check ([Color_Ral] like ('%[A-Z][0-9][0-9][0-9][0-9]%')),
)
go
...
[Name_Type_Application] [varchar] (100) not null unique,
...
[Name_Type_Surface] [varchar] (50) not null unique,
...
[Name_Shine] [varchar] (50) not null unique,
